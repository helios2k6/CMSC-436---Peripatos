...
public class TestRequest extends Test {
	...
	public TestRequest() throws JDOMException, IOException{
		SAXBuilder builder = new SAXBuilder();
		doc = builder.build(new StringReader(XML_STRING_REQUEST));
	}
	
	public Document testRequestURLValid() throws IOException, JDOMException{
		URL url = new URL(URL_FOR_REQUESTS);
